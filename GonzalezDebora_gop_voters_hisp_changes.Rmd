...
fig2a <- augment(ecm1) %>%
  ...
  labs(title = "",
       subtitle = "",
       x = "Change in Prop. Unemployed, 2011 to 2016",
...
fig2b <- augment(ecm1) %>%
  ...
  labs(title = "",
       subtitle = "",
       x = "Change in Prop. Hispanic, 2011 to 2016",
       y = "Predicted Change in GOP Vote Share") +
  theme_classic()
...
Hispanics are a large demographic group and is rapidly growing in the United States. The influence they have on the nation's politics and political outcomes is essential to academics and politicians alike. HHH's paper offers clear indication that Hispanic presence translates to decreased proportion of Republican voters
